//
//  ConfirmationBottomViewController.swift
//  lockDown
//
...
protocol ConfirmationBottomProtocol {
...
class ConfirmationBottomViewController: BottomPopupViewController {
    ...
    @IBAction func ConfirmBtnDidTap(_ sender: Any) {
        self.delegate?.ConfirmBtnDidtap()
    }
...
extension ConfirmationBottomViewController: UIGestureRecognizerDelegate {
