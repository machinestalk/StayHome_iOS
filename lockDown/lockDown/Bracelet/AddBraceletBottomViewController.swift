//
//  AddBraceletBottomViewController.swift
//  lockDown
//
...
protocol AddBraceletProtocol {
    func scanForBracelet()
    func addBraceletManually()
    
}
class AddBraceletBottomViewController: BottomPopupViewController {
    @IBOutlet weak var handleArea: UIView!
    var delegate: AddBraceletProtocol?
    ...
    @IBAction func addmanuallyDidTap(_ sender: Any) {
        self.delegate?.addBraceletManually()
    }
    
    @IBAction func scanDidTap(_ sender: Any) {
        self.delegate?.scanForBracelet()
    }
}
extension AddBraceletBottomViewController: UIGestureRecognizerDelegate {
