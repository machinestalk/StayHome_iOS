//
//  BraceletConnectBottomViewController.swift
//  lockDown
//
...
class BraceletConnectBottomViewController: BottomPopupViewController {
    ...
    extension BraceletConnectBottomViewController: UIGestureRecognizerDelegate {
