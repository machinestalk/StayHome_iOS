//
//  BiometricsBottomViewController.swift
//  lockDown
//
//  Created by Aymen HECHMI on 03/04/2020.
...
protocol BiometricsAuthProtocol {
    func requestRecognition()

}

class BiometricsBottomViewController: BottomPopupViewController {
    ...
    var delegate: BiometricsAuthProtocol?
    ...
    override func viewDidLoad() {
        ...
        titleLbl.text = "BiometricsAuth_title_txt".localiz()
        msgLbl.text = "BiometricsAuth_msg_txt".localiz()
    ...
    @IBAction func nextBtnAction(_ sender: Any) {
         self.delegate?.requestRecognition()
    }
...
extension BiometricsBottomViewController: UIGestureRecognizerDelegate {
