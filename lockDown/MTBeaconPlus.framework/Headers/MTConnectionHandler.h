...
@class MTConnectionFeature, MinewFrame, MTTriggerData, MTSensorHandler, MTLineBeaconData;
...
*/
- (void)setLineBeaconHWID:(NSString *)hwid VendorKey:(NSString *)vendorKey completion:(MTCOperationBlock)completionHandler;
...
*/
- (void)setLineBeaconLotkey:(NSString *)lotkey completion:(MTCOperationBlock)completionHandler;
